    ...
    if cfg['sensors'][table_name]['enabled'] is False:
        ...
        if 'serial_number' in fields:
            ...
            if len(sn) == 1:
                ...
                ds[f"{table_name}_serial_number"] = (('time'), np.array(_dict['serial_number']).astype(fields_nptypes['serial_number']))
        ...
        if 'output_wavelengths' in fields:
            ...
            if len(ow) == 1:
                ...
                ds[f"output_wavelengths"] = (('time'), np.array(_dict['output_wavelengths']).astype(fields_nptypes['output_wavelengths']))
        ...
        other_vars = [v for v in fields if v != 'time' and v != 'serial_number' and v != 'kfactor' and v != 'wavelength_a' and v!= 'wavelength_c' and v!='dev_file' and v!= 'output_wavelengths']
